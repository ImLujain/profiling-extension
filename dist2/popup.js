...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@keyframes filling{0%{stroke-dashoffset:var(--e4003b50)}to{stroke-dashoffset:var(--4931f474)}}.circle-progress__circle{fill:transparent;stroke-width:var(--1485b33e)}.circle-progress__line--back{stroke:#eceef1;stroke-dashoffset:0}.circle-progress__line--top{animation-name:filling;animation-duration:var(--668842eb);animation-timing-function:ease-in;transition:all .5s}.circle-progress__line--top--rounded{stroke-linecap:round}.circle-progress{display:flex;position:relative;justify-content:center;align-items:center}.circle-progress__line--filled{stroke:var(--b266a2d0)}.circle-progress__line--unfilled{stroke:var(--3aa830f1)}.circle-progress__content{position:absolute;left:0;right:0;top:0;bottom:0;display:flex;justify-content:center;align-items:center;flex-direction:column}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".access-insights h2[data-v-17cd46cb]{font-size:18px;color:#333}.local-storage-data li.highlight-red[data-v-17cd46cb]{background-color:rgba(236,80,69,.5)}.local-storage-data li.highlight-orange[data-v-17cd46cb]{background-color:rgba(255,165,69,.5)}.local-storage-data li.highlight-yellow[data-v-17cd46cb]{background-color:rgba(255,255,70,.5)}.local-storage-data li[data-v-17cd46cb]{padding:8px;border:1px solid #ddd;border-radius:4px}#popup-container[data-v-17cd46cb]{font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif;color:#4a4a4a;background-color:#f9f9f9;max-width:400px;width:262px;padding:15px;box-shadow:0 4px 8px rgba(0,0,0,.1);border-radius:10px;overflow:hidden}.tab-headers[data-v-17cd46cb]{display:flex;justify-content:space-around;margin:20px 0 0 0;background-color:#007bff}.tab-headers button[data-v-17cd46cb]{background-color:transparent;border:none;padding:4px 10px;cursor:pointer;font-size:12px;color:#fff;transition:background-color .3s,color .3s}.tab-headers button[data-v-17cd46cb]:hover{background-color:#0056b3;color:#f9f9f9}.tab-headers .active-tab[data-v-17cd46cb]{background-color:#f2f2f2!important;color:#007bff}.local-storage-data[data-v-17cd46cb],.trackers-summary[data-v-17cd46cb]{background:#6c757d0d;padding:12px 6px;border-radius:5px;font-size:12px}p[data-v-17cd46cb]{margin:10px 0;font-size:16px}span[data-v-17cd46cb]{color:#007bff;font-weight:600}.local-storage-data h2[data-v-17cd46cb]{font-size:18px;color:#333;margin-bottom:10px}.local-storage-data ul[data-v-17cd46cb]{list-style-type:none;padding:0}.local-storage-data li[data-v-17cd46cb]{background-color:#fff;padding:10px;border:1px solid #b6d4fe;margin-bottom:5px;border-radius:6px;font-size:14px}.open-dashboard-container button[data-v-17cd46cb]{background-color:#007bff;color:#fff;padding:7px 14px;border:none;border-radius:5px;cursor:pointer;transition:background-color .3s}.open-dashboard-container button[data-v-17cd46cb]:hover{background-color:#0056b3}.div-header[data-v-17cd46cb]{padding:10px 0;border-bottom:1px solid gray;font-family:Orbitron,sans-serif}.open-dashboard[data-v-17cd46cb]{text-align:center;margin-top:20px;font-size:11px}.circle-progress__line--filled[data-v-17cd46cb],circle.circle-progress__circle.circle-progress__line--top.circle-progress__line--filled[data-v-17cd46cb]{stroke:#027bff!important}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
var update = add("1c937f2c", content, true, {"sourceMap":false,"shadowMode":false});
...
// add the styles to the DOM
var add = (__webpack_require__(402)/* ["default"] */ .Z)
var update = add("3e83a924", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/view/CircleProgressBar.vue?vue&type=script&setup=true&lang=js



const _hoisted_1 = { class: "circle-progress" }
const _hoisted_2 = {
...
const _hoisted_3 = ["r"]
const _hoisted_4 = ["r"]
const _hoisted_5 = { class: "circle-progress__content" }
const _hoisted_6 = {
  key: 0,
...
/* harmony default export */ var CircleProgressBarvue_type_script_setup_true_lang_js = ({
...
useCssVars(_ctx => ({
  "e4003b50": (dashArray.value),
  "4931f474": (dashOffset.value),
  "1485b33e": (props.strokeWidth),
  "668842eb": (props.animationDuration),
  "b266a2d0": (props.colorFilled),
  "3aa830f1": (props.colorUnfilled)
}))



const isLimitReached = runtime_core_esm_bundler_computed(() => props.max <= props.value);
const fillingCircleClasses = runtime_core_esm_bundler_computed(() => {
  return {
...
const fillingCircleStyles = runtime_core_esm_bundler_computed(() => {
  return {
...
const currentFormatted = runtime_core_esm_bundler_computed(() => isLimitReached.value ? props.max : props.value);

const fillingCircle = reactivity_esm_bundler_ref(null);
const radius = reactivity_esm_bundler_ref(48);
const dashArray = runtime_core_esm_bundler_computed(() => radius.value * Math.PI * 2);
const dashOffset = runtime_core_esm_bundler_computed(() => {
...
const getPercentage = runtime_core_esm_bundler_computed(() => {
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    (openBlock(), createElementBlock("svg", _hoisted_2, [
      ...
      createBaseVNode("circle", {
        class: normalizeClass(["circle-progress__circle circle-progress__line--top", fillingCircleClasses.value]),
        style: normalizeStyle(fillingCircleStyles.value),
    ...
    createBaseVNode("div", _hoisted_5, [
      (__props.percentage)
        ? (openBlock(), createElementBlock("span", _hoisted_6, toDisplayString(getPercentage.value), 1))
...
;// CONCATENATED MODULE: ./src/view/CircleProgressBar.vue?vue&type=script&setup=true&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/view/CircleProgressBar.vue?vue&type=style&index=0&id=2abdf240&lang=css
var CircleProgressBarvue_type_style_index_0_id_2abdf240_lang_css = __webpack_require__(414);
;// CONCATENATED MODULE: ./src/view/CircleProgressBar.vue?vue&type=style&index=0&id=2abdf240&lang=css

;// CONCATENATED MODULE: ./src/view/CircleProgressBar.vue



;

const __exports__ = CircleProgressBarvue_type_script_setup_true_lang_js;

/* harmony default export */ var CircleProgressBar = (__exports__);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/view/popup.vue?vue&type=script&setup=true&lang=ts


const _withScopeId = n => (pushScopeId("data-v-17cd46cb"), n = n(), popScopeId(), n);
const popupvue_type_script_setup_true_lang_ts_hoisted_1 = { id: "popup-container" };
const popupvue_type_script_setup_true_lang_ts_hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ createBaseVNode("div", { class: "div-header text-center" }, "Detected Trackers", -1));
const popupvue_type_script_setup_true_lang_ts_hoisted_3 = { class: "tab-headers" };
const popupvue_type_script_setup_true_lang_ts_hoisted_4 = { class: "tab-content" };
const popupvue_type_script_setup_true_lang_ts_hoisted_5 = {
    key: 0,
    class: "trackers-summary"
};
const popupvue_type_script_setup_true_lang_ts_hoisted_6 = { class: "row" };
const _hoisted_7 = { class: "col-12 mt-3 mb-3" };
const _hoisted_8 = { class: "col-12" };
const _hoisted_9 = { class: "value float-right" };
const _hoisted_10 = { class: "col-12" };
const _hoisted_11 = { class: "value float-right" };
const _hoisted_12 = {
    key: 1,
    class: "access-insights"
};
const _hoisted_13 = {
    key: 0,
    class: "local-storage-data"
};
const _hoisted_14 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ createBaseVNode("h6", null, "Local Storage Data:", -1));
const _hoisted_15 = { key: 1 };


/* harmony default export */ var popupvue_type_script_setup_true_lang_ts = (/*#__PURE__*/runtime_core_esm_bundler_defineComponent({
    __name: 'popup',
    setup(__props) {
        const currentTab = reactivity_esm_bundler_ref('trackers');
        const uniqueTrackersCount = reactivity_esm_bundler_ref(0);
        const totalCount = reactivity_esm_bundler_ref(0);
        const uniqueTrackers = reactivity_esm_bundler_ref(0);
        const uniqueParentDomains = reactivity_esm_bundler_ref(0);
        let localStorageData = reactivity_esm_bundler_ref(null);
        ...
        const parsedLocalStorageData = runtime_core_esm_bundler_computed(() => {
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createElementBlock("div", popupvue_type_script_setup_true_lang_ts_hoisted_1, [
                popupvue_type_script_setup_true_lang_ts_hoisted_2,
                createBaseVNode("div", popupvue_type_script_setup_true_lang_ts_hoisted_3, [
                    createBaseVNode("button", {
                        class: normalizeClass({ 'active-tab': currentTab.value === 'accesses' }),
                        onClick: _cache[0] || (_cache[0] = ($event) => (currentTab.value = 'accesses'))
                    }, "Access Insights", 2),
                    createBaseVNode("button", {
                        class: normalizeClass({ 'active-tab': currentTab.value === 'trackers' }),
                        onClick: _cache[1] || (_cache[1] = ($event) => (currentTab.value = 'trackers'))
                    }, "Trackers Summary", 2)
                ]),
                createBaseVNode("div", popupvue_type_script_setup_true_lang_ts_hoisted_4, [
                    (currentTab.value === 'trackers')
                        ? (openBlock(), createElementBlock("div", popupvue_type_script_setup_true_lang_ts_hoisted_5, [
                            createBaseVNode("div", popupvue_type_script_setup_true_lang_ts_hoisted_6, [
                                createBaseVNode("div", _hoisted_7, [
                                    runtime_core_esm_bundler_createVNode(CircleProgressBar, {
                                        value: uniqueTrackersCount.value,
                                        max: uniqueTrackersCount.value
                                    }, {
                                        default: withCtx(() => [
                                            createTextVNode(toDisplayString(uniqueTrackersCount.value), 1)
                                        ]),
                                        _: 1
                                    }, 8, ["value", "max"])
                                ]),
                                createBaseVNode("div", _hoisted_8, [
                                    createTextVNode(" Unique Trackers: "),
                                    createBaseVNode("span", _hoisted_9, toDisplayString(uniqueTrackers.value), 1)
                                ]),
                                createBaseVNode("div", _hoisted_10, [
                                    createTextVNode(" Unique Parent Domains: "),
                                    createBaseVNode("span", _hoisted_11, toDisplayString(uniqueParentDomains.value), 1)
                                ])
                            ])
                        ]))
                        : createCommentVNode("", true),
                    (currentTab.value === 'accesses')
                        ? (openBlock(), createElementBlock("div", _hoisted_12, [
                            (unref(localStorageData))
                                ? (openBlock(), createElementBlock("div", _hoisted_13, [
                                    _hoisted_14,
                                    createBaseVNode("ul", null, [
                                        (openBlock(true), createElementBlock(Fragment, null, renderList(parsedLocalStorageData.value, (item, index) => {
                                            return (openBlock(), createElementBlock("li", {
                                                key: index,
                                                class: normalizeClass(getHighlightClass(item))
                                            }, toDisplayString(item), 3));
                                        }), 128))
                                    ])
                                ]))
                                : (openBlock(), createElementBlock("p", _hoisted_15, "No data found for this domain."))
                        ]))
                        : createCommentVNode("", true)
                ]),
                createBaseVNode("div", { class: "open-dashboard-container open-dashboard" }, [
                    createBaseVNode("button", { onClick: openDashboard }, "Open Dashboard")
                ])
            ]));
        };
    }
...
;// CONCATENATED MODULE: ./src/view/popup.vue?vue&type=script&setup=true&lang=ts
 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/view/popup.vue?vue&type=style&index=0&id=17cd46cb&scoped=true&lang=css
var popupvue_type_style_index_0_id_17cd46cb_scoped_true_lang_css = __webpack_require__(386);
;// CONCATENATED MODULE: ./src/view/popup.vue?vue&type=style&index=0&id=17cd46cb&scoped=true&lang=css
...
const popup_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(popupvue_type_script_setup_true_lang_ts, [['__scopeId',"data-v-17cd46cb"]])

/* harmony default export */ var popup = (popup_exports_);
;// CONCATENATED MODULE: ./src/entry/popup.ts
