...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/view/TrackerHandlerComponent.vue?vue&type=script&setup=true&lang=js





/* harmony default export */ var TrackerHandlerComponentvue_type_script_setup_true_lang_js = ({
  __name: 'TrackerHandlerComponent',
  setup(__props) {
...
const initExtensionListeners = () => {
    chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) {
        //No events listeners yet. I kept it to show you how to set it up with Vue onMount even
        if (message.action === "setUserAgent") {
            //Replace this with future event listener
        }
    });
}
...
;// CONCATENATED MODULE: ./src/view/TrackerHandlerComponent.vue?vue&type=script&setup=true&lang=js
 
;// CONCATENATED MODULE: ./src/view/TrackerHandlerComponent.vue



const __exports__ = TrackerHandlerComponentvue_type_script_setup_true_lang_js;

/* harmony default export */ var TrackerHandlerComponent = (__exports__);
...
window.addEventListener("load", () => {
    ...
    htmlElement === null || htmlElement === void 0 ? void 0 : htmlElement.appendChild(contentDetectorWrapper);
